...
# Configuration
Hold L + Down + Select to open the Roséverse Options Menu. From here, there are several things that you can configure:
...
- All the people who helped worked on this project, you can see them at [https://projectrose.cafe](https://unitendo.org); also, any others who are not mentioned.

# Issues?
> [!NOTE]
If you find any issues with **the patcher itself** or have any suggestions, please open a GitHub Issue [here](https://github.com/Project-Rosee/Inkay-Roseverse/issues). If you need support for Roséverse itself or have any questions that aren't answered here, please ask in our [Discord server](https://discord.gg/dNrn73szZQ), which is more active.
